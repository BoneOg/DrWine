...
export default function Welcome() {
    ...
    return (
        <Layout>
            ...
            {/* ===== MENU SECTION START ===== */}
            <div
                className="w-screen min-h-screen flex items-center justify-center relative z-10 bg-cover bg-center" // Changed to min-h-screen and added flex utilities
                style={{
            ...
            >
                ...
                <div className="max-w-6xl mx-auto px-5 md:px-10 lg:px-20 flex flex-col md:flex-row items-center justify-between text-white relative z-20 py-16"> {/* Added py-16 for inner content padding */}
                    <div className="md:flex-1 max-w-full md:max-w-xl text-center md:text-left mb-12 md:mb-0 md:mr-16">
                        <h2 className="mb-4 font-arizonia text-white text-6xl sm:text-7xl md:text-8xl">
                            {menuHeading}
                        </h2>
                        <p className="mb-10 text-sm sm:text-base leading-relaxed text-gray-300 px-2 md:px-0">
                    ...
                    {/* Adjusted to contain only one image and made responsive */}
                    <div className="md:flex-1 flex justify-center items-center max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg w-full md:ml-16">
                        <img
