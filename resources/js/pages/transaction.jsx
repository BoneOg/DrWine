                        ...
                        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
                            {transaction ? (
                                <div className="space-y-4 md:space-y-8">
                                    ...
                                    <motion.div 
                                        className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-none p-6 md:p-8 hover:bg-white/[0.04] transition-all duration-300"
                                        {...fadeIn}
                                    >
                                        <div className="flex items-center gap-3 md:gap-4 mb-6">
                                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-[#CDAF7B] to-[#E5C992] flex items-center justify-center transform hover:rotate-12 transition-transform duration-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 text-black" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                                                </svg>
                                            </div>
                                            <h2 className="text-xl md:text-2xl font-felix text-white">Guest Information</h2>
                                        </div>
                                        <div className="space-y-2 md:space-y-4 font-monts divide-y divide-white/10">
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Name</span>
                                                <span className="text-white/90 text-sm">{customer?.name || 'N/A'}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Phone</span>
                                                <span className="text-white/90 text-sm">{customer?.phone || 'N/A'}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Email</span>
                                                <span className="text-white/90 text-sm">{customer?.email || 'N/A'}</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2 md:space-y-4 font-monts divide-y divide-white/10">
                                            ...
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                ...
                                                <span className="text-white/90 text-sm">{reservation?.size || 'N/A'} {reservation?.size > 1 ? 'guests' : 'guest'}</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 md:gap-4 mb-6">
                                            ...
                                            <h2 className="text-xl md:text-2xl font-felix text-white">Payment Details</h2>
                                        </div>
                                        <div className="space-y-2 md:space-y-4 font-monts divide-y divide-white/10">
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Payment Method</span>
                                                <span className="text-white/90 text-sm">{transaction.payment_method || 'N/A'}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Amount</span>
                                                <span className="text-white/90 text-base md:text-lg">₱{parseFloat(transaction.amount).toFixed(2)}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Status</span>
                                                <span className="px-3 md:px-4 py-1 md:py-1.5 bg-gradient-to-r from-[#CDAF7B] to-[#E5C992] text-black rounded-full text-sm font-medium">
                                                    Confirmed
                                                </span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Transaction ID</span>
                                                <span className="font-mono text-white/90 text-sm">{transaction.transactionID || transaction.id}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-2 md:py-3">
                                                <span className="text-[#CDAF7B] text-sm">Date & Time</span>
                                                <span className="text-white/90 text-sm">{new Date(transaction.created_at).toLocaleString()}</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                ...
                                <div className="text-center py-16 md:py-20">
                                    <p className="text-[#CDAF7B] font-monts text-sm md:text-base">No transaction details found.</p>
                                </div>
                            )}
                        </div>
                    </div>
