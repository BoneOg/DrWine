  ...
  return (
    <Layout>
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        {/* Left Side (Image + Small Text + Button) */}
        ...
        <div className="space-y-8">
          <h2 className="text-[1rem] md:text-[1.75rem] font-felix leading-tight text-white tracking-tight">
            Dr. Wine is where stories are poured and flavors composed, blending warmth and elegance in the heart of BGC.          </h2>
          <div>
            <h3 className="text-lg mb-4 uppercase tracking-wider text-">Our Goal</h3>
...
<div className='bg-[#000C1C] px-8'>
  <h3 className='text-white font-felix text-center text-3xl mb-12'>BEHIND THE DISHES</h3>

  <div className='max-w-7xl mx-auto grid md:grid-cols-3 gap-8'>

    {/* Profile 1 */}
    <div className='backdrop-blur-xl bg-white/[0.02] border border-[#CDAF7B]/40 p-4 space-y-4 hover:bg-white/[0.04]'>
    ...
    <div className='backdrop-blur-xl bg-white/[0.02] border border-[#CDAF7B]/40 p-4 space-y-4 hover:bg-white/[0.04]'>
      ...
      <div className='text-white text-sm leading-relaxed'>
        <h4 className='text-[#CDAF7B] font-semibold mb-1'>Chef Marc</h4>
        <p>Bold yet grounded, Chef Marc brings a fearless creativity to the kitchen. His technique is shaped by tradition, but his passion lies in reinventing the familiar. Each plate he creates is a journey—rich with contrast, depth, and the unexpected joy of discovery.</p>
      </div>
    </div>
    ...
    <div className='backdrop-blur-xl bg-white/[0.02] border border-[#CDAF7B]/40 p-4 space-y-4 hover:bg-white/[0.04]'>
      ...
      <div className='text-white text-sm leading-relaxed'>
        <h4 className='text-[#CDAF7B] font-semibold mb-1'>Chef Gema</h4>
        <p>Chef Gema cooks with intuition and heart, drawing inspiration from family traditions and the warmth of home. Her dishes are soulful, vibrant, and layered with memory—designed to evoke comfort, connection, and a sense of celebration in every bite.</p>
      </div>
    </div>
