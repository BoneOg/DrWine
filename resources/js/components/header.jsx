                    ...
                    >
                        ...
                        <div className="mt-auto pt-8 space-y-4 font-monts">
                            <motion.button
                                ...
                                className="w-full group relative px-6 py-3 text-sm tracking-wider overflow-hidden rounded-md"
                            ...
                            <motion.button
                                ...
                                className="w-full group relative px-6 py-3 border border-white/10 text-sm tracking-wider text-white rounded-md hover:text-[#CDAF7B] transition-colors duration-300"
                                whileHover={{ scale: 1.03 }}
                                whileTap={{ scale: 0.97 }}
                            >
